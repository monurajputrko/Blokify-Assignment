...
const InstagramButton = ({setFlag}) => (
  <button onClick={()=>setFlag(true)} className="card1">
    <svg
        class="whatsapp"
...
const TwitterButton = ({setFlag}) => (
  <button onClick={()=>setFlag(true)} className="card2">
...
const GithubButton = ({setFlag}) => (
  <button onClick={()=>setFlag(true)} className="card3">
...
const DiscordButton = ({setFlag}) => (
  <button onClick={()=>setFlag(true)} className="card4">
...
const SocialMediaButtons = ({setFlag}) => (
  <div className="main">
    <div className="up">
      <InstagramButton setFlag={setFlag} />
      <TwitterButton setFlag={setFlag} />
    </div>
    <div className="down">
      <GithubButton setFlag={setFlag} />
      <DiscordButton setFlag={setFlag} />
    </div>
  </div>
);
