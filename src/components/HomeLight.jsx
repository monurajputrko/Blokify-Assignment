  ...
  return (
    <div ref={contentRef} className={styles.homeLight}>
      ...
      <div
       ...
       >
        <div style={{display:"flex",alignItems:"center",justifyContent:"center"}} className={styles.image}>
          <img style={{marginLeft: isSmallScreen ? "" : "25px"}} className={styles.heroImageIcon} alt="" src="/heroimg.png" />
        </div>
        <div style={{ marginTop: isLargeScreen ? "" : "365px", marginLeft: isLargeScreen ? "" : isSmallScreen ? "-70px" : "-250px" }}>
          ...
          />
          <div
            style={{ marginTop: isLargeScreen ? "0" : isSmallScreen ? "350px" : "350px", marginLeft: isLargeScreen ? "" : isSmallScreen ? "-70px" : "-250px" }}
          ...
          <div style={{ marginTop: isLargeScreen ? "-20px" : "325px",marginLeft: isLargeScreen ? "" : isSmallScreen ? "-70px" : "-250px"}} className={styles.tagLine}>
      ...
      <div style={{display:isSmallScreen ? "" : "none"}} className={styles.socialsLinks}>
        <img
      ...
      <div style={{ marginTop: isLargeScreen ? "-70px" : "270px",marginLeft: isLargeScreen ? "" : isSmallScreen ? "-70px" : "-250px" }} className={styles.buttons}>
        <img
          style={{
            marginLeft: "-0px",
            width: "40%",
